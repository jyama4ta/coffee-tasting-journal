  ...
  if (!shop) {
    return (
      <div className="max-w-2xl mx-auto text-center py-8">
        ...
        <Button href="/admin/shops" variant="outline" className="mt-4">
          店舗一覧に戻る
        </Button>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
        ...
        <span>/</span>
        <Link href={`/admin/shops/${shop.id}`} className="hover:text-gray-900">
          {shop.displayName}
        </Link>
        <span>/</span>
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          <Button href={`/admin/shops/${shop.id}`} variant="outline">
            キャンセル
          </Button>
        </div>
      </form>
