...
| 15  | ブランド名と店舗名     | ブランド名と店舗名を分けて登録できる             | 201 + brandName, name含む                |
| 16  | ブランド名と店舗名     | ブランド名のみでも登録できる（店舗名なし）       | 201 + brandName含む、name空              |
| 17  | ブランド名と店舗名     | 店舗名のみでも登録できる（従来互換）             | 201 + brandName=null, name含む           |
| 18  | ブランド名と店舗名     | ブランド名も店舗名も空の場合は400エラー          | 400 + エラーメッセージ                   |
| 19  | ブランド名と店舗名     | displayNameにブランド名と店舗名が結合して含まれる | 200 + displayName="ブランド 店舗"       |
| 20  | ブランド名と店舗名     | 店舗名のみの場合displayNameは店舗名のみ          | 200 + displayName=店舗名                |
| 21  | ブランド名と店舗名     | ブランド名のみの場合displayNameはブランド名のみ  | 200 + displayName=ブランド名            |
| 22  | ブランド名と店舗名     | 一覧取得時もdisplayNameが含まれる                | 200 + 全件にdisplayName含む             |
...
5. **ブランド名/店舗名**: ブランド名と店舗名の組み合わせパターン、displayName生成ロジック
...
- `GrindSizeSlider > 目盛り表示 > 整数目盛りが長く表示される（h-3クラス）`
