...
| #   | カテゴリ                  | テストケース                      |
| --- | ------------------------- | --------------------------------- |
| 1   | GET /api/drippers         | 空の配列を返す                    |
| 2   | GET /api/drippers         | 全てのドリッパーを返す            |
| 3   | POST /api/drippers        | 新しいドリッパーを作成する        |
| 4   | POST /api/drippers        | ドリッパー名のみで作成できる      |
| 5   | POST /api/drippers        | ドリッパー名が空の場合は400エラー |
| 6   | GET /api/drippers/[id]    | 指定したIDのドリッパーを返す      |
| 7   | GET /api/drippers/[id]    | 存在しないIDの場合は404エラー     |
| 8   | PUT /api/drippers/[id]    | ドリッパーを更新する              |
| 9   | DELETE /api/drippers/[id] | ドリッパーを削除する              |
...
| #   | カテゴリ                 | テストケース                               |
| --- | ------------------------ | ------------------------------------------ |
| 1   | GET /api/filters         | 空の配列を返す                             |
| 2   | GET /api/filters         | 全てのフィルターを返す                     |
| 3   | POST /api/filters        | 新しいフィルターを作成する                 |
| 4   | POST /api/filters        | フィルター名のみで作成できる               |
| 5   | POST /api/filters        | フィルター種類（type）を指定して作成できる |
| 6   | GET /api/filters/[id]    | 指定したIDのフィルターを返す               |
| 7   | PUT /api/filters/[id]    | フィルターを更新する                       |
| 8   | DELETE /api/filters/[id] | フィルターを削除する                       |
