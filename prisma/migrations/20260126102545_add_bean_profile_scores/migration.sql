...
INSERT INTO "new_coffee_beans" ("amount", "beanType", "createdAt", "finishedDate", "id", "imagePath", "isDecaf", "name", "notes", "origin", "price", "process", "purchaseDate", "roastLevel", "shopId", "status", "updatedAt", "url") SELECT "amount", "beanType", "createdAt", "finishedDate", "id", "imagePath", "isDecaf", "name", "notes", "origin", "price", "process", "purchaseDate", "roastLevel", "shopId", "status", "updatedAt", "url" FROM "coffee_beans";
